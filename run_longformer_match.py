import os
from net.longformer_classify import LongformerForClassification
...
from transformers import AutoConfig, LongformerForSequenceClassification
...
def create_batch_iter(args: TrainingArguments, mode: str, logger):
    """构造迭代器"""
    pairs = read_data(args.data_dir + "train.csv")
...
def main():
    ...
    config = AutoConfig.from_pretrained(model_dir, num_labels=2, return_dict=True)
